...
const items =[{
    ...
    className:"bg-blue-100  border border-blue-200 dark:bg-neutral-100/10 dark:border-neutral-100/10",
...
},
{
    ...
    className:"bg-green-100 border border-green-200 dark:bg-neutral-100/10 dark:border-neutral-100/10",
...
},
{
    ...
    className:"bg-indigo-100 border border-indigo-200 dark:bg-neutral-100/10 dark:border-neutral-100/10",
...
},
{
    ...
    className:"bg-neutral-100 border border-neutral-200 dark:bg-neutral-100/10 dark:border-neutral-100/10",
...
},
{
    ...
    className:"bg-purple-100 border border-purple-200 dark:bg-neutral-100/10 dark:border-neutral-100/10",
    description: "Automatically trigger approvals based on predefined criteria, ensuring timely review and compliance.",
    tags:[
        {text:"Salesforce" , icon:<SalesforceIcon className="size-3"/>},
        {text:"Hubspot" , icon:< HubspotIcon className="size-3"/>},
   ...
   <div className="flex-1 gap-2 flex flex-col rounded-t-3xl bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 max-w-[20rem] lg:max-w-sm mx-auto w-full h-full absolute inset-x-0 p-2">
...
const Card = ({topIcon, title, description, tags, className}) => {
    ...
    <motion.div 
    key={title}
    className="p-4 gap-4 shadow-black/10 border border-transparent bg-white dark:bg-neutral-900 ring-1 ring-black/10 rounded-[16px] flex items-start flex-col">
   ...
   >
    ...
    className="text-lg font-bold text-neutral-800 dark:text-neutral-200">{title}</motion.p>
    </div>
     <motion.div
     initial={{
     opacity:0,
    ...
    <p className="text-sm mt-2 mb-4 text-neutral-600 dark:text-neutral-400 rounded-sm border border-neutral-200 dark:border-neutral-600 px-2 py-1 border-dashed">{description}</p>
...
const Tag = ({text, icon}) => {
    return(
        <div className="flex items-center gap-1 px-1 py-0.5 border border-neutral-100 dark:border-neutral-800 text-sm rounded-sm">
            {icon}
            <p className="text-xs text-neutral-500 dark:text-neutral-600">{text}</p>
        </div>
    )
}