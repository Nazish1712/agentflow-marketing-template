...
export const SkeletonOne = () => {
    return(
     <div className="flex-1 gap-2 flex flex-col rounded-t-3xl bg-neutral-100  border border-neutral-200  mx-auto w-full h-full absolute inset-x-10 pt-2 px-4 inset-y-2">
        ...
        badge={<div className="flex gap-1 items-center px-1 py-0.5 rounded-md border border-neutral-200">
        ...
        badge={<div className="flex gap-1 items-center px-1 py-0.5 rounded-md bg-red-100 border border-red-200">
        ...
        badge={<div className="flex gap-1 items-center px-1 py-0.5 rounded-md bg-yellow-100 border border-yellow-200">
...
const Card = ({children}) => {
    return(
        <div className="gap-4 shadow-black/10 border border-transparent bg-white ring-1 ring-black/10 
    rounded-tl-[16px] flex flex-col items-start flex-1">
...
const CardItem = ({icon, title, description, badge, iconClassName}) => {

    return(
     <div className="flex justify-between items-center w-full pl-4 relative overflow-hidden">
        <div className="gap-2 flex items-center">
        <div className={`size-4 rounded-sm bg-blue-500 text-white flex items-center justify-center ${iconClassName}`}>
            {icon}
        </div>
            <p className="text-sm text-neutral-600">{title}</p>
            {badge}
        </div>
        <p className="text-sm text-neutral-500 flex-nowrap max-w-[16rem] whitespace-nowrap w-full text-left">{description}</p>
    </div>)
}
