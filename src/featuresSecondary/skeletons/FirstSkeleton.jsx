...
export const SkeletonOne = () => {
    return(
     <div className="flex-1 gap-2 flex flex-col rounded-t-3xl bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 max-w-[20rem] lg:max-w-sm mx-auto w-full h-full absolute inset-x-0 p-2">
        <Card 
...
const Card = ({topIcon, title, description, tags}) => {
    ...
    return(
    <div className="p-4 gap-4 shadow-black/10 border border-transparent bg-white dark:bg-neutral-800 ring-1 ring-black/10 rounded-[16px] flex items-start">
...
const Tag = ({text, icon}) => {
    return(
        <div className="flex items-center gap-1 px-1 py-0.5 border border-neutral-100 dark:border-neutral-700 text-sm rounded-sm">
            {icon}
